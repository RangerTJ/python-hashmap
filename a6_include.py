# The following code was provided by Oregon State University as part of its CS-261 Data Structures Course.
# It provides the basis for implementing an OA and SC Hashmap by defining a Dynamic Array, Linked List, Hash Entry,
# and provides two specific hash functions that were used in assignment unit tests (though others can be used too).
